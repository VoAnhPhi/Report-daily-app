...
interface ProductReviewResultEmailProps {
  productName: string;
...
export const ProductReviewResultEmail = ({
...
}: ProductReviewResultEmailProps) => {
  const isApproved = action === 'approved';
  const previewText = isApproved
    ? 'Yêu cầu duyệt sản phẩm đã được phê duyệt'
    : 'Yêu cầu duyệt sản phẩm đã bị từ chối';
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={text}>
              Yêu cầu{' '}
              <strong style={highlightText}>{reviewTypeLabel}</strong> sản phẩm{' '}
            ...
            <Text style={footer}>
              Bạn nhận được email này vì bạn đã gửi yêu cầu duyệt sản phẩm
              trên hệ thống ACTA.
            </Text>
          </Section>
...
export default ProductReviewResultEmail;
