...
export const ProductAvailabilitySubscriptionConfirmationEmail = ({
  productName = '',
  productSlug = '',
  type = 'OPEN_SALE',
  ...
  const subject = `Đã ghi nhận đăng ký nhận thông báo — ${productName}`;
  const bodyText = `Chúng tôi sẽ gửi email khi sản phẩm ${productName} sẵn sàng.`;
  const typeLabel =
    type === 'OPEN_SALE' ? 'Mở bán' : 'Có hàng trở lại';
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            <Heading style={h2}>Đã ghi nhận đăng ký</Heading>
