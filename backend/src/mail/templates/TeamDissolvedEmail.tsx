...
interface TeamDissolvedEmailProps {
  userName: string;
  teamName: string;
}
...
export const TeamDissolvedEmail = ({
  ...
  <Html lang="vi">
    ...
    <Preview>Team {teamName} đã bị giải tán</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          <Heading style={h1}>Thông báo về team</Heading>
          ...
          <Text style={text}>
            Chúng tôi thông báo rằng team <strong>{teamName}</strong> đã bị giải
            tán bởi quản trị viên.
          </Text>

          <Text style={text}>
            Vì vậy, bạn không còn là thành viên của team này nữa. Tất cả các
            hoạt động và dữ liệu liên quan đến team này sẽ được lưu trữ theo quy
            định của hệ thống.
          </Text>
