...
export const ReviewSubmittedEmail = ({
  ...
  <Html lang="vi">
    ...
    <Preview>{`Yêu cầu duyệt ${entityLabel} mới — chờ xử lý`}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          <Heading style={h1}>{`Yêu cầu duyệt ${entityLabel}`}</Heading>
          ...
          <Text style={text}>
            ...
            {targetName ? (
              <>
                {' '}
                <strong style={highlightText}>&ldquo;{targetName}&rdquo;</strong>
              </>
            ) : null}
            .
          </Text>
          ...
          {summary ? (
            <Text style={text}>
              <strong style={highlightText}>Tóm tắt:</strong> {summary}
            </Text>
          ) : null}

          <Text style={text}>
            Vui lòng xem xét và phê duyệt yêu cầu này trong hệ thống quản trị
            ACTA.
          </Text>
          ...
          <Text style={footer}>
            Bạn nhận được email này vì bạn có quyền duyệt {entityLabel} trên hệ
            thống ACTA.
          </Text>
        </Section>
