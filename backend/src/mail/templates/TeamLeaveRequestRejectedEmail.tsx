...
interface TeamLeaveRequestRejectedEmailProps {
  userName: string;
  teamName: string;
  rejectionReason?: string;
}

export const TeamLeaveRequestRejectedEmail = ({
  userName = 'Thành viên',
  teamName = 'Team',
  rejectionReason,
}: TeamLeaveRequestRejectedEmailProps) => (
  <Html lang="vi">
    <Head>
    ...
    <Preview>Yêu cầu rời team {teamName} của bạn đã bị từ chối</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          <Heading style={h1}>Yêu cầu rời team đã bị từ chối ❌</Heading>
          ...
          <Text style={text}>
            Chúng tôi rất tiếc thông báo rằng yêu cầu rời team{' '}
            <strong>{teamName}</strong> của bạn đã không được chấp nhận.
          </Text>
          ...
          <Text style={text}>
            Bạn vẫn là thành viên của team <strong>{teamName}</strong>. Nếu bạn
            có bất kỳ thắc mắc nào về quyết định này, vui lòng liên hệ với quản
            trị viên team hoặc đội hỗ trợ của chúng tôi.
          </Text>
