...
interface TeamLeaveRequestApprovedEmailProps {
  userName: string;
  teamName: string;
}

export const TeamLeaveRequestApprovedEmail = ({
  userName = 'Thành viên',
  teamName = 'Team',
}: TeamLeaveRequestApprovedEmailProps) => (
  <Html lang="vi">
    <Head>
    ...
    <Preview>Yêu cầu rời team {teamName} của bạn đã được chấp nhận</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={content}>
          <Heading style={h1}>Yêu cầu rời team đã được chấp nhận</Heading>
          ...
          <Text style={text}>
            Yêu cầu rời team <strong>{teamName}</strong> của bạn đã được quản
            trị viên chấp nhận.
          </Text>

          <Text style={text}>
            Bạn đã chính thức rời khỏi team. Chúng tôi cảm ơn bạn đã là một phần
            của team và chúc bạn thành công trong các dự án tiếp theo.
          </Text>
